    ...
    def self.available_options
      ...
      [
        ...
        FastlaneCore::ConfigItem.new(key: :ignore_profiles_with_different_name,
                                     ...
                                     is_string: false,
                                     default_value: false),
        FastlaneCore::ConfigItem.new(key: :offline_support,
                                     env_name: "SIGH_OFFLINE_SUPPORT",
                                     description: "Whether the profile supports installing and running the app without an active internet connection",
                                     optional: true,
                                     is_string: false,
                                     default_value: false),
